    ...
    <div className="min-h-dvh bg-white">
      ...
      <header className="sticky top-0 z-30 border-b border-[color:var(--border)] bg-white/95 backdrop-blur">
        <div className="mx-auto flex h-[52px] w-full max-w-md items-center justify-between px-[var(--spacing-3)]">
          ...
          <div className="text-[length:var(--font-size-sm)] font-bold text-[#191919]">
            지킴진단
          </div>
          <button
            type="button"
      ...
      <main className="mx-auto w-full max-w-md px-[var(--spacing-5)] pt-[var(--spacing-5)] pb-[calc(env(safe-area-inset-bottom)+var(--spacing-10))]">
        ...
        <section className="pb-[var(--spacing-6)]">
          <div className="flex items-start justify-between gap-[var(--spacing-4)]">
            <div className="min-w-0">
              <h2 className="whitespace-pre-line text-[length:var(--font-size-base)] font-bold leading-[length:var(--font-leading-7)] text-[#191919]">
                {propertyAddress || "주소 정보"}
              </h2>
              <p className="mt-[var(--spacing-1)] text-[length:var(--font-size-sm)] leading-[length:var(--font-leading-6)] text-[#7f7f7f]">
                {formatKRW(expectedDeposit)} ・ 전세({contractTerm || "계약기간"})
              </p>
            </div>
            <div className="grid h-16 w-16 place-items-center rounded-2xl bg-slate-50 text-xs font-bold text-gray-400">
              이미지
            </div>
          </div>

          {/* AI 종합 진단 의견 */}
          <div className="mt-[var(--spacing-3)] rounded-[var(--border-radius-3xl)] bg-gradient-to-l from-[#ececff]/50 to-[#eef6ff]/50 p-[var(--spacing-5)]">
            <div className="flex flex-col items-center gap-[var(--spacing-3)]">
              <div className="inline-flex items-center gap-1 rounded-full bg-gradient-to-l from-[#4042ff] to-[#57a3ff] px-2 py-1 text-[10px] font-bold leading-3 text-white">
                AI 종합 진단 의견
              </div>
              <p className="whitespace-pre-line text-center text-[length:var(--font-size-base)] leading-[length:var(--font-leading-7)] text-[#191919]">
                {summary?.body ??
                  (reportType === "risky"
            ...
            <div className="mt-[var(--spacing-6)] space-y-[var(--spacing-3)]">
              {/* 확인 필요 카운트 카드 */}
              <div className="rounded-[var(--border-radius-3xl)] bg-white p-[var(--spacing-5)] shadow-sm ring-1 ring-black/5">
                <p className="text-center text-[length:var(--font-size-sm)] text-[#4c4c4c]">
                  <span className="font-bold">확인이 필요한 항목</span>
                  <span className="font-medium">들이 있어요!</span>
                </p>
                <ul className="mt-[var(--spacing-3)] space-y-[var(--spacing-2)] text-[length:var(--font-size-sm)] text-[#4c4c4c]">
              ...
              <button
                ...
                className="w-full rounded-[var(--border-radius-3xl)] bg-white p-[var(--spacing-5)] text-left shadow-sm ring-1 ring-black/5"
              >
                <p className="text-center text-[length:var(--font-size-sm)] text-[#4c4c4c]">
                  <span className="font-bold">이 집 맞춤형 특약도 확인</span>
                  <span className="font-medium">해보세요!</span>
                </p>
                <div className="mt-[var(--spacing-3)] flex items-center justify-between text-[length:var(--font-size-sm)] text-[#4c4c4c]">
                  <span>✅ 안전한 계약을 위한 추천 특약</span>
                  <span className="font-bold">{clauseMessages.length}개</span>
                </div>
              </button>

              <p className="text-center text-[10px] leading-3 text-[#b3b3b3]">
        ...
        {/* 탭 (Sticky) */}
        <nav className="sticky top-[52px] z-20 -mx-[var(--spacing-5)] border-b border-[color:var(--border)] bg-white">
        ...
        <div className="mt-[var(--spacing-6)] space-y-[var(--spacing-10)]">
          ...
          >
            <h3 className="text-[length:var(--font-size-xl)] font-bold leading-[30px] text-[#191919]">
              집의 권리관계를 분석하여
              <br />
              위험한 요소들을 체크했어요!
            </h3>
            <p className="mt-[var(--spacing-1)] text-[length:var(--font-size-sm)] leading-[length:var(--font-leading-6)] text-[#4c4c4c]">
            ...
            <div className="mt-[var(--spacing-4)] rounded-[var(--border-radius-3xl)] bg-gradient-to-l from-[#4042ff]/5 to-[#57a3ff]/5 p-[var(--spacing-5)] text-center">
              <div className="mx-auto inline-flex items-center gap-1 rounded-full bg-white px-2 py-1 text-[11px] font-bold text-[#373dff]">
                집 위험도 분석 AI 요약
              </div>
              <p className="mt-[var(--spacing-2)] whitespace-pre-line text-[length:var(--font-size-base)] leading-[length:var(--font-leading-7)] text-[#191919]">
                {summary?.title ??
            ...
            <div className="mt-[var(--spacing-7)]">
              <h4 className="text-[length:var(--font-size-lg)] font-bold leading-[length:var(--font-leading-7)] text-[#191919]">
                📌 기본 정보
              </h4>
              <hr className="my-[var(--spacing-3)] border-t border-[#f2f2f2]" />
                  ...
                  return (
                    <div key={f.key}>
                      <div className="flex items-start justify-between gap-[var(--spacing-4)] px-[var(--spacing-1)] py-[var(--spacing-2)]">
                        <span className="text-[length:var(--font-size-base)] font-bold leading-[length:var(--font-leading-7)] text-[#191919]">
                          {f.title}
                        </span>
                        <span className="whitespace-pre-line text-right text-[length:var(--font-size-base)] leading-[length:var(--font-leading-7)] text-[#191919]">
                          {String(rendered)}
                        </span>
                      </div>
                      {f.description ? (
                        <div className="px-[var(--spacing-1)] pb-[var(--spacing-2)]">
                          <div className="rounded-[var(--border-radius-2xl)] bg-[#f7f7f7] px-[var(--spacing-4)] py-[var(--spacing-3)]">
                            <div className="text-[13px] font-bold leading-[18px] text-[#4c4c4c]">
                              💬 참고
                            </div>
                            <div className="mt-1 whitespace-pre-line text-[13px] leading-[18px] text-[#191919]">
                              {f.description}
                            </div>
                          </div>
                        </div>
                    ...
                    <div key={card.key} className="py-[var(--spacing-1)]">
                      ...
                      >
                        <div className="flex min-w-0 items-center gap-2">
                          <span className="truncate text-[length:var(--font-size-base)] font-bold leading-[length:var(--font-leading-7)] text-[#191919]">
                            {card.title}
                          </span>
                          <span
                            className={cn(
                              ...
                              failed
                                ? "bg-[#ffeceb] text-[#f94e3e]"
                                : "bg-[#e6f5d3] text-[#259b04]"
                            )}
                          >
                            {pill}
                          </span>
                        ...
                        <div className="flex shrink-0 items-center gap-2">
                          <span className="text-[length:var(--font-size-base)] leading-[length:var(--font-leading-7)] text-[#191919]">
                      ...
                      {open ? (
                        <div className="pb-[var(--spacing-4)]">
                          {failed ? (
                            <div className="mx-[var(--spacing-1)] mb-[var(--spacing-2)] rounded-[var(--border-radius-2xl)] border border-[#f94e3e] bg-[#fff6f5] px-[var(--spacing-4)] py-[var(--spacing-3)]">
                              <div className="text-[13px] font-bold leading-[18px] text-[#4c4c4c]">
                                ❗ 확인이 필요해요
                              </div>
                              <div className="mt-1 text-[13px] leading-[18px] text-[#191919]">
                                {card.failText || "해당 항목이 발견되었어요."}
                              </div>
                            </div>
                          ) : null}

                          <div className="mx-[var(--spacing-1)] rounded-[var(--border-radius-2xl)] bg-[#f7f7f7] px-[var(--spacing-4)] py-[var(--spacing-3)]">
                            <div className="text-[13px] font-bold leading-[18px] text-[#4c4c4c]">
                              💬 설명
                            </div>
                            <div className="mt-1 whitespace-pre-line text-[13px] leading-[18px] text-[#191919]">
                          ...
                          {failed ? (
                            <button
                              ...
                              className="mx-[var(--spacing-1)] mt-[var(--spacing-2)] w-full rounded-[var(--border-radius-xl)] border border-[#e6e6e6] bg-white px-4 py-2.5 text-[13px] font-medium leading-[18px] text-[#191919]"
                            >
                              계약 전, 맞춤 특약 바로 보기
                            </button>
                          ) : null}
          ...
          >
            ...
            <div className="mt-[var(--spacing-6)] rounded-[var(--border-radius-3xl)] bg-white p-[var(--spacing-5)] shadow-sm ring-1 ring-black/5">
              <div className="text-[length:var(--font-size-base)] font-bold text-[#191919]">
                기본 정보
              </div>
            ...
            <div className="mt-[var(--spacing-6)] divide-y divide-[#f2f2f2] rounded-[var(--border-radius-3xl)] bg-white shadow-sm ring-1 ring-black/5">
              {rulesBySection.owner.map((card) => {
                ...
                return (
                  <div key={card.key} className="px-[var(--spacing-4)] py-[var(--spacing-1)]">
                    ...
                    >
                      <div className="flex min-w-0 items-center gap-2">
                        <span className="truncate text-[length:var(--font-size-base)] font-bold text-[#191919]">
                          {card.title}
                        </span>
                        <span
                          className={cn(
                      ...
                      <div className="flex shrink-0 items-center gap-2">
                        <span className="text-[length:var(--font-size-sm)] text-[#191919]">
            ...
            <div className="mt-[var(--spacing-6)] rounded-[var(--border-radius-3xl)] bg-white p-[var(--spacing-5)] shadow-sm ring-1 ring-black/5">
              <div className="flex items-start justify-between gap-[var(--spacing-4)]">
                ...
                <div className="text-right">
                  <div className="tabular-nums text-[length:var(--font-size-xl)] font-bold text-[#191919]">
          ...
          >
            ...
            <div className="mt-[var(--spacing-6)] space-y-[var(--spacing-2)]">
              {clauseMessages.map((m) => (
                <div
                  key={m.key}
                  className="rounded-[var(--border-radius-3xl)] border border-[color:var(--border)] bg-white p-[var(--spacing-5)] shadow-sm"
                >
                  <div className="text-[length:var(--font-size-base)] font-bold text-[#191919]">
                    {m.title}
                  </div>
                  <div className="mt-[var(--spacing-2)] whitespace-pre-line text-[length:var(--font-size-sm)] leading-[length:var(--font-leading-6)] text-gray-700">
                    {m.body}
                  </div>
                </div>
              ))}
              {!clauseMessages.length ? (
                <div className="rounded-[var(--border-radius-3xl)] border border-[color:var(--border)] bg-white p-[var(--spacing-5)] text-sm text-gray-600">
                  (표시할 특약이 없어요)
                </div>
              ) : null}
            </div>
        ...
        <div className="mt-[var(--spacing-8)] text-center text-xs text-gray-400">
